const CACHE='kpc-orientirovka-v49';
const SHARE_CACHE='kpc-shared-tracks-v1';
const ASSETS=['./','./index.html','./styles.css?v=49','./app-v5.js?v=49','./firebase-config.js','./manifest.webmanifest?v=49','./template.jpg','./icon.svg','./icon-192.png','./icon-512.png','./vendor/jspdf.umd.min.js'];
