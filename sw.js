const CACHE='kpc-orientirovka-v48';
const SHARE_CACHE='kpc-shared-tracks-v1';
const ASSETS=['./','./index.html','./styles.css?v=48','./app-v5.js?v=48','./firebase-config.js','./manifest.webmanifest?v=48','./template.jpg','./icon.svg','./icon-192.png','./icon-512.png','./vendor/jspdf.umd.min.js'];
