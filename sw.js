const CACHE='kpc-orientirovka-v64';
const SHARE_CACHE='kpc-shared-tracks-v1';
const ASSETS=['./','./index.html','./styles.css?v=64','./app-v5.js?v=64','./archive-result.js?v=64','./track-map.js?v=64','./wind-rose.js?v=64','./data/weather-stations.json?v=64','./firebase-config.js','./manifest.webmanifest?v=58','./template.jpg','./icon.svg','./icon-192.png','./icon-512.png','./vendor/jspdf.umd.min.js','./vendor/fflate.js','./vendor/fitsdk/src/accumulator.js','./vendor/fitsdk/src/bit-stream.js','./vendor/fitsdk/src/crc-calculator.js','./vendor/fitsdk/src/decoder.js','./vendor/fitsdk/src/fit.js','./vendor/fitsdk/src/profile.js','./vendor/fitsdk/src/stream.js','./vendor/fitsdk/src/utils-hr-mesg.js','./vendor/fitsdk/src/utils-internal.js','./vendor/fitsdk/src/utils-memo-glob.js','./vendor/fitsdk/src/utils.js'];
